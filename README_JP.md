...
- [入門的内容](#入門的内容)
  - [イントロダクション](#イントロダクション)
    - [ScenarioFlowとは](#scenarioflowとは)
    - [なぜScenarioFlowを使うのか](#なぜscenarioflowを使うのか)
  - [ScenairoFlowを始める](#scenairoflowを始める)
  - [会話シーンの再生方法](#会話シーンの再生方法)
    - [コマンドとスクリプト](#コマンドとスクリプト)
    - [ScenarioScriptとScenarioBook](#scenarioscriptとscenariobook)
...
- [発展的内容](#発展的内容)
  ...
  - [ScenarioBookの構造](#scenariobookの構造)
...
多言語実装のために使用されます。詳細は[LocalizedSFText_JP](./LocalizedSFText_JP.md)を確認してください。
